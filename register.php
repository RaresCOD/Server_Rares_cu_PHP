  ...
  <main class="form-signin">
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      if ($firstName == null || $lastName == null || $email == null || $password == null) {
        ...
        $error = validRegisterInput($firstName, $lastName, $email, $password, $pdo);
        if (strlen($error) != 0) {
          echo $error;
          ...
          $pdo->exec("INSERT INTO users(id,firstName,lastName,email,password) VALUES('$id','$firstName','$lastName','$email','$password');");
          $_SESSION["id"] = $id;
